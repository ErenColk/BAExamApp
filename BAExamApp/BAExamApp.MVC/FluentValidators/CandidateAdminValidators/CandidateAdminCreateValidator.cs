...
public class CandidateAdminCreateValidator : AbstractValidator<CandidateAdminCreateVM>
{
    public CandidateAdminCreateValidator(IStringLocalizer<CandidateAdminCreateVM> stringLocalizer)
    {

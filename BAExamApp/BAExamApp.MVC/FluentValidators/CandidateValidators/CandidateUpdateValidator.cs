...
public class CandidateUpdateValidator : AbstractValidator<CandidateAdminCandidateUpdateVM>
{
    public CandidateUpdateValidator(IStringLocalizer<CandidateAdminCandidateUpdateVM> stringLocalizer)
    {

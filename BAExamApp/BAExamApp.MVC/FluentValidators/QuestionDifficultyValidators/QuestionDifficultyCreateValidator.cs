...
public class QuestionDifficultyCreateValidator : AbstractValidator<AdminQuestionDifficultyCreateVM>
{
    public QuestionDifficultyCreateValidator(IStringLocalizer<AdminQuestionDifficultyCreateVM> stringLocalizer)
    {
        RuleFor(x => x.Name)

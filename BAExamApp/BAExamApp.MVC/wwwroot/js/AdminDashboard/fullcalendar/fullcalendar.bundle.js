...
var FullCalendar = (function (e) {
  ...
  /*! *****************************************************************************
    ...
    ***************************************************************************** */ var t =
            ...
            function e(e) {
                ...
                for (var o in e)
                    o in Zt
                        ...
                        : ((t[o] = e[o]), o in $t && (r = Math.max($t[o], r)));
    ...
    function Ri(e, t) {
        for (
            var n = St(t.getCurrentData().eventSources), r = [], o = 0, i = e;
            o < i.length;
            o++
        ) {
                    ...
                    for (var m in u) {
                        ...
                        for (var T in f) {
                            ...
                            if (qn(E, x.range)) {
                                ...
                                if (S && !S(new _r(t, p[x.defId], x), new _r(t, D, y)))
                                    return !1;
                            }
                        }
                        for (var C = i.eventStore, k = 0, R = b.allows; k < R.length; k++) {
                            var _ = R[k],
                                ...
                                P = C.instances[m],
                                N = void 0;
                            if (((N = I ? new _r(t, I, P) : new _r(t, D)), !_(yr(M, t), N)))
                                return !1;
                        }
                    }
                    return !0;
    ...
    function fl(e, t, n, r, o, i, a) {
        ...
        for (
            ...
            for (var D = x.firstCol; D <= x.lastCol; D += 1)
                h[D].push({
                    seg: hl(x, D, D + 1, a),
                    isVisible: !1,
                    isAbsolute: !1,
                ...
                (t.prototype.renderFgSegs = function (e, t, n, o, i, a, s) {
                    ...
                    if (c)
                        for (var h = 0, v = t; h < v.length; h++) {
                            ...
                            D &&
                                (l.isRtl
                                    ? ((S = 0), (w = c.lefts[m.lastCol] - c.lefts[m.firstCol]))
                                    : ((w = 0),
                                        (S = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                                f.push(
                                    Co(
                                        "div",
                                        {

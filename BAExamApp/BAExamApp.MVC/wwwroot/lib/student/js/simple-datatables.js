                ...
                function (require, module, exports) {
                            ...
                            Promise.all(p).then((n) => {
                                ...
                                Array.from(r).forEach((e) => {
                                    ...
                                    (a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i),
                                        parseFloat(a) == a ? (h[d++] = { value: Number(a), row: e }) : (o[l++] = { value: "string" == typeof i ? i.toLowerCase() : i, row: e });
                                }),
                                    e || (e = c.classList.contains("asc") ? "desc" : "asc"),
                                    "desc" == e
                                        ? ((u = a(o, -1)), (g = a(h, -1)), c.classList.remove("asc"), c.classList.add("desc"), c.setAttribute("aria-sort", "descending"))
                                        : ((u = a(h, 1)), (g = a(o, 1)), c.classList.remove("desc"), c.classList.add("asc"), c.setAttribute("aria-sort", "ascending")),
                                    i.lastTh && c != i.lastTh && (i.lastTh.classList.remove("desc"), i.lastTh.classList.remove("asc"), i.lastTh.removeAttribute("aria-sort")),
                                    (i.lastTh = c),
                                    (r = u.concat(g)),
                                    (i.data = []);
                                const f = [];
                    ...
                    const o = function (t) {
                        ...
                        h = {
                            ...
                            labels: {
                                placeholder: "Ara...",
                                perPage: "{select} adet gösteriliyor",
                                noRows: "Hiçbir girdi bulunamadı",
                                noResults: "Arama sorgunuzla eşleşen sonuç yok",
                                info: "{rows} öğeden {start} - {end} arası gösteriliyor.",
                            },
                    ...
                    exports.DataTable = class {
                        constructor(t, e = {}) {
                            ...
                            if (
                                ((this.options = { ...h, ...e, layout: { ...h.layout, ...e.layout }, labels: { ...h.labels, ...e.labels } }),
                        ...
                        render() {
                            ...
                            if (
                                ((this.headings = []),
                                    ...
                                    this.options.footer ? this.head && !this.foot && ((this.foot = e("tfoot", { html: this.head.innerHTML })), this.dom.appendChild(this.foot)) : this.foot && this.dom.removeChild(this.dom.tFoot),
                            ...
                            if (this.options.searchable) {
                                const e = `<div class='dataTable-search'><input class='dataTable-input border border-dark' placeholder='${this.options.labels.placeholder}' type='text'></div>`;
                        ...
                        renderPage(t = !1) {
                            ...
                            let e,
                                ...
                                n = 0;
                            if (
                                (this.totalPages && ((i = this.currentPage - 1), (a = i * this.options.perPage), (n = a + this.pages[i].length), (a += 1), (e = this.searching ? this.searchData.length : this.data.length)),
                        ...
                        bindEvents() {
                            ...
                            this.options.searchable && ((this.input = this.wrapper.querySelector(".dataTable-input")), this.input && this.input.addEventListener("keyup", () => this.search(this.input.value), !1)),
                                    ...
                                    (t) => {
                                        ...
                                        e &&
                                            ...
                                            (e.hasAttribute("data-page")
                                                ...
                                                (this.columns.sort(this.headings.indexOf(e.parentNode)), t.preventDefault()));
                                    },
                                    !1
                                ),
                                    ...
                                    ? (this.table.addEventListener("keydown", (t) => {
                                        38 === t.keyCode
                                            ? this.rows.cursor.previousElementSibling
                                                ? (this.rows.setCursor(this.rows.cursor.previousElementSibling), t.preventDefault(), t.stopPropagation())
                                                : this.onFirstPage || this.page(this.currentPage - 1, !0)
                                            : 40 === t.keyCode
                                                ? this.rows.cursor.nextElementSibling
                                                    ? (this.rows.setCursor(this.rows.cursor.nextElementSibling), t.preventDefault(), t.stopPropagation())
                                                    : this.onLastPage || this.page(this.currentPage + 1)
                                                : [13, 32].includes(t.keyCode) && this.emit("datatable.selectrow", this.rows.cursor, t);
                                    }),
                        ...
                        paginate() {
                            ...
                            return (
                                this.searching && ((t = []), this.searchData.forEach((e) => t.push(this.activeRows[e]))),
